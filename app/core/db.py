...
def seed_services(session: Session) -> None:
    ...
    categories = [
        {"name": "Auto Repair", "icon": "🔧", "services": [
        ...
        {"name": "Hair & Beauty", "icon": "✂️", "services": [
